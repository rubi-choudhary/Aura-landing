<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Lagoon-Contact-requests.aspx.cs" Inherits="Admin_Lagoon_Contact_requests" %>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Manage Lagoon Contact Request</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/Admin/">Dashboard</a></li>
                                <li class="breadcrumb-item active"><a href="javascript: void(0);">Lagoon Contact Request</a></li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Manage All Lagoon Contact Request</h4>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $(document).ready(function () {
            $(document.body).on('click', '.deleteItem', function () {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: 'POST',
                            url: "Lagoon-Contact-requests.aspx/Delete",
                            data: "{id: '" + id + "'}",
            ...
            $(document.body).on('click', '#Viewcust', function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: "Lagoon-Contact-requests.aspx/GetContactMessage",
                    data: "{id: '" + id + "'}",
                    contentType: 'application/json; charset=utf-8',
                    dataType: "json",
                    async: false,
